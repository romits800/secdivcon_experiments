...
#for dist in "hamming" "reg_hamming" "reg_cyc_hamming"
for dist in "reg_cyc_hamming"
do
for agap in 0 10 # 20 #50
do
    DIVS_DIR=divs_${agap}_${dist}_${suff}
    time timeout 10m $GEC/gecode-secdiversify  ${flags} \
                                    --acceptable-gap $agap \
                                    --relax $relax \
                                    --seed $seed \
                                    --distance ${dist} \
